...
export const ENGINE_PRESETS: EnginePreset[] = [
  ...
  },
  {
    ...
    inputs: {
      ...
      peakTorque_Nm: 2500,
      numberOfCylinders: 6,
      exhaustFlowRate_kg_h: 1600,
      exhaustTemp_C: 380,
      exhaustPressure_kPa: 108,
      CO_ppm: 350,
      HC_ppm: 60,
      NOx_ppm: 1000,
      NO2_fraction: 0.1,
  ...
  {
    name: "500 kW Natural Gas Genset",
    inputs: {
      engineType: "natural_gas",
      application: "genset",
      displacement_L: 21,
      ratedPower_kW: 500,
      ratedSpeed_rpm: 1500,
      ...
      exhaustFlowRate_kg_h: 2200,
      exhaustTemp_C: 450,
      exhaustPressure_kPa: 103,
      CO_ppm: 600,
      HC_ppm: 1200,
      NOx_ppm: 500,
      NO2_fraction: 0.05,
  ...
  },
  {
    ...
    inputs: {
      ...
      exhaustFlowRate_kg_h: 4500,
      exhaustTemp_C: 480,
      exhaustPressure_kPa: 104,
      CO_ppm: 800,
      HC_ppm: 1500,
      NOx_ppm: 600,
      NO2_fraction: 0.05,
